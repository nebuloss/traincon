 ...
 *
 * The head is the familiar three lamps rather than the five a carré-capable
 * target really carries: at the size this is shown, five lenses leave each a
 * few pixels across. What the two stop aspects are told apart by is the
 * œilleton, which is how they are told apart on the ground — see the README
 * beside the drawings.
 *
